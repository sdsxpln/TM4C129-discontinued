 ...
 *----------------------------------------------------------*/
#define PRIORITY_HTTPD_TASK                         ( 4U )
#define PRIORITY_CONTROL_TASK                       ( 3U )
#define configLWIP_TASK_PRIORITY                    ( 3U )
#define PRIORITY_DISPLAY_TASK                       ( 2U )
#define configFILE_SYSTEM_DEMO_TASK_PRIORITY		( 2U )
#define PRIORITY_LED_TASK                           ( 1U )
#define configUART_COMMAND_CONSOLE_TASK_PRIORITY    ( 1U ) 
#define configCOMMAND_INTERPRETER_TASK_PRIORITY		( 0U )
 
/* Define STACK size for all threads */
#define configUART_COMMAND_CONSOLE_STACK_SIZE		( configMINIMAL_STACK_SIZE * 2UL )
#define configCOMMAND_INTERPRETER_STACK_SIZE		( configMINIMAL_STACK_SIZE * 2UL )
